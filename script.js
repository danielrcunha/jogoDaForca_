...
const categorias = {
    frutas: ["abacaxi", "limao", "laranja", "maracuja", "banana", "goiaba", "melancia", "ameixa", "sapoti"],
    profissoes: ["engenheiro","advogado", "bombeiro", "padeiro","administrador", "motorista", "pedreiro", "programador", "gerente"],
    animais: ["papagaio","galo","cachorro","gato", "galinha", "hipopotamo", "tartaruga", "tubarao"],
    cores: ["amarelo","azul", "vermelho", "preto", "branco", "verde", "marrom"],
    Personagem_naruto: ["naruto", "itachi", "gaara", "kabuto", "orochimaru", "tsunade", "jiraiya", "minato", "nagato", "kakashi", "sasuke", "madara"]
};
